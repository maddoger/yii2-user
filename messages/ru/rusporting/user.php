...
return array (
  ...
  'Provides authorization and password reset (with captcha) for backend application.' => 'Обеспечивает авторизацию и сброс пароля (с капчей) для панели администратора.',
  ...
  'Update User: {name}' => 'Редакирование пользователя: {name}',
  'Update role: {name}' => 'Редакирование роли: {name}',
  'Update roles' => 'Редактировать роли',
